...
# Rastreador de tesouraria familiar e metas

**Rastreador de tesouraria familiar e metas**

<p>
  <a href="https://github.com/SrSatriano/family-treasury-dao-tracker"><img src="https://img.shields.io/badge/GitHub-family-treasury-dao-tracker-24292e?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
</p>
...
<p><strong>Cofres virtuais, projeção de juros compostos e governança familiar leve.</strong></p>
...
| | |
|---|---|
| **Problema** | Famílias não têm visibilidade conjunta de metas financeiras de longo prazo. |
| **Solução** | API de cofres, aportes e UI com projeção FV documentada. |

## Para quem é

Famílias, grupos de investimento informal.
...
- [x] API REST de cofres
- [x] Projeção com juros compostos
- [x] UI React responsiva
- [x] SQLite zero-config
- [x] Filosofia de design documentada

## Stack tecnológica

| Camada | Tecnologias |
|--------|-------------|
| **Principal** | React, Vite, Express, SQLite |
...
- SQLite não escala para milhares de usuários concorrentes
...
<p align="center">Desenvolvido com foco em clareza e engenharia de produção · <a href="https://github.com/SrSatriano/family-treasury-dao-tracker">Ver no GitHub</a></p>
