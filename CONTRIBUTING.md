...
Obrigado por considerar uma contribuição para **Rastreador de tesouraria familiar e metas**.

## Como começar

1. Faça um fork do repositório [family-treasury-dao-tracker](https://github.com/SrSatriano/family-treasury-dao-tracker).
2. Crie uma branch: `git checkout -b feat/minha-melhoria`
3. Instale dependências conforme o [README](README.md).
4. Execute os testes: `npm test --prefix backend`
...
- Resumo das mudanças
- Como testou (`npm test --prefix backend`)
