# Arquitetura — Rastreador de tesouraria familiar e metas

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

API de cofres, aportes e UI com projeção FV documentada.
...
|------------|------------------|
| API | API REST de cofres |
| Projeção | Projeção com juros compostos |
| UI | UI React responsiva |
| SQLite | SQLite zero-config |
| Filosofia | Filosofia de design documentada |
