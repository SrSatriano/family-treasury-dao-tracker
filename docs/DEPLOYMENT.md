# Guia de deploy — Rastreador de tesouraria familiar e metas

> Versão **1.0.0** · Stack: **React, Vite, Express, SQLite**
...
3. Execute `npm test --prefix backend` ou smoke tests automatizados.
